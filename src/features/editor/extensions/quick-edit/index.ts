  ...
  return [
    {
      ...
      create() {
        ...
        dom.className =
          "bg-popover text-popover-foreground rounded-sm border-border-input  p-2 shadow-md flex flex-col gap-2 text-sm z-50";

        const form = document.createElement("form");
        form.className = "flex flex-col gap-2";
        const input = document.createElement("input");
        input.type = "text";
        input.placeholder = "Edit selected code with AI...";
        input.className =
          "bg-transparent outline-none border-none rounded-sm px-2 py-1 font-sans w-100";
        ...
        submitButton.className =
          "font-sans p-1 px-2 bg-primary text-primary-foreground rounded-sm hover:bg-primary/90 disabled:pointer-events-none disabled:opacity-50";
...
const quickEditKeymap = Prec.highest(keymap.of([
  {
    key: "Mod-k",
    preventDefault: true,
    run(view) {
