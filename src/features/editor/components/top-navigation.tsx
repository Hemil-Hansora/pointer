...
const Tab = ({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-2 pr-1.5 pl-2 h-8.75 cursor-pointer border-y border-x border-transparent text-muted-foreground  group hover:bg-accent/30",
        isActive &&
    ...
    >
      ...
      <button
        ...
        className={cn(
            "p-0.5 rounded-sm hover:bg-destructive-foreground/10 opacity-0 group-hover:opacity-100",
